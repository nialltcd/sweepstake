...
@Component({
  selector: 'app-dolan',
  templateUrl: './dolan.component.html',
  styleUrls: ['./dolan.component.css']
})
export class DolanComponent implements OnInit {
  ...
  players = [
    { name: "Roisin", teams: ["Spain","Italy","Austria","Russia","Scotland"]},
{ name: "Emma", teams: ["France","Denmark","Wales","Slovakia","North Macedonia"]},
{ name: "James", teams: ["Belgium","Germany","Netherlands","Turkey","Czech Republic"]},
{ name: "Mary", teams: ["Portugal","Croatia","Poland","Ukraine","BYE"]},
{ name: "Gerry", teams: ["England","Switzerland","Sweden","Hungary","Finland"]},
  ]
